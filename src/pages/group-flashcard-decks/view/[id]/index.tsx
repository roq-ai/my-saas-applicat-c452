...
import { getGroupFlashcardDeckById } from 'apiSdk/group-flashcard-decks';
...
function GroupFlashcardDeckViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Group Flashcard Deck Detail View
          </Text>
          {hasAccess('group_flashcard_deck', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/group-flashcard-decks/edit/${data?.id}`} passHref legacyBehavior>
              <Button
